!function (e) {
    ...
    (function (o) {
        ...
        !function (n, o) {
            ...
            function o(e, t, n) {
                ...
                var o, l;
                return function () {
                    var i = n || this, s = +new Date, r = arguments;
            ...
            if ("undefined" != typeof window) {
                ...
                return c.destroy = function () {
                    ...
                    if (f && (r = t(s, e || {}), this.options = r, this.state = {}, r.scrollSmooth && (r.duration = r.scrollSmoothDuration, c.scrollSmooth = n(5).initSmoothScrolling(r)), l = a(r), i = u(r), this._buildHtml = l, this._parseContent = i, c.destroy(), null !== (d = i.selectHeadings(r.contentSelector, r.headingSelector)))) {
                        var m = i.nestHeadingsArray(d), h = m.nest;
                        return l.render(r.tocSelector, h), this._scrollListener = o(function (e) {
                            l.updateToc(d);
                            var t = e && e.target && e.target.scrollingElement && 0 === e.target.scrollingElement.scrollTop;
                            (e && (0 === e.eventPhase || null === e.currentTarget) || t) && (l.enableTocAnimation(), l.updateToc(d), r.scrollEndCallback && r.scrollEndCallback(e))
                        }, r.throttleTimeout), this._scrollListener(), document.addEventListener("scroll", this._scrollListener, !1), document.addEventListener("resize", this._scrollListener, !1), this._clickListener = o(function (e) {
    ...
    e.exports = function (e) {
        ...
        function l(t) {
            var n = document.createElement("ol"), o = e.listClass + h + e.extraListClasses;
        ...
        function s(t) {
            ...
            if (m && null !== document.querySelector(e.tocSelector) && l.length > 0) {
                ...
                var a = document.querySelector(e.tocSelector).querySelector("." + e.linkClass + ".node-name--" + o.nodeName + '[href="#' + o.id + '"]');
                -1 === a.className.indexOf(e.activeLinkClass) && (a.className += h + e.activeLinkClass);
                var p = a.parentNode;
        ...
        return {enableTocAnimation: a, disableTocAnimation: c, render: n, updateToc: s}
    }
}, function (e, t) {
    e.exports = function (e) {
        function t(e) {
    ...
    function n(e) {
        ...
        var i = e.duration, s = location.hash ? n(location.href) : location.href;
        !function () {
            function n(n) {
